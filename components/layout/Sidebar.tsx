        ...
        {menus.map((page: MenuProps) => (
          <Link key={page.url} href={page.url}>
            ...
            >
              ...
              <h3 className='text-white font-poppins leading-[28px] ml-[20px] text-[1.3vh]'>
                {page.title}
              </h3>
            </div>
          </Link>
      ...
      <div className='w-full grid gap-y-[0.5vh] grid-cols-1'>
        <Link href='/comingsoon'>
          <div className='flex flex-col items-start'>
            ...
            >
              <Image src='/icons/comingsoon.png' width={"17vh"} height={"17vh"} />
              <h3 className='text-white font-poppins leading-[2.5vh] ml-[20px] font-semibold text-[1.5vh]'>
                Coming Soon
              </h3>
            </div>
            <div className='grid grid-cols-1 gap-y-5 mt-[10px] text-start pl-[40px] opacity-80'>
              {comingsoons.map((title: string) => (
                <h3
                  key={title}
                  className='text-white font-poppins leading-[2vh] font-semibold hover:cursor-pointe text-[1.3vh]'
                >
                  {title}
                </h3>
              ))}
      ...
      <div className='w-full grid gap-y-[0.5vh] grid-cols-1'>
        {submenus.map((page: MenuProps) => (
          <Link key={page.url} href={page.url}>
            ...
            >
              <Image src={page.iconUrl} width={"17vh"} height={"17vh"} />
              <h3 className='text-white font-poppins leading-[2.5vh] ml-[20px] text-[1.3vh]'>
                {page.title}
              </h3>
            </div>
          </Link>

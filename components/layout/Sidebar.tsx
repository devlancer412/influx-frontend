    ...
    <div className='flex-col justify-around bg-black bg-opacity-50 bg-blend-soft-light backdrop-blur-[15px] w-[240px] hidden md:flex'>
      ...
      >
        {profile.loggedin ? (
          ...
          <h5 className='text-[#FFFFFFC8] text-[1.6vh] leading-[3vh] xl:text-[1.3vh] xl:leading-[2.5vh] font-medium'>
            Login/Signup
          </h5>
        )}
      </div>
        ...
        {menus.map((page: MenuProps) => (
          <Link key={page.url} href={page.url}>
            ...
            >
              ...
              <h3 className='text-white font-poppins text-[1.6vh] leading-[3vh] xl:text-[1.3vh] xl:leading-[2.5vh] ml-[20px]'>
                {page.title}
              </h3>
            </div>
          </Link>
          ...
          <div className='flex flex-col items-start'>
            ...
            >
              <Image
                ...
                height={'17vh'}
              />
              <h3 className='text-white font-poppins ml-[20px] font-semibold text-[1.6vh] leading-[3vh] xl:text-[1.3vh] xl:leading-[2.5vh]'>
                Coming Soon
              </h3>
            </div>
            <div className='grid grid-cols-1 gap-y-5 mt-[10px] text-start pl-[40px] opacity-80'>
              {comingsoons.map((title: string) => (
                <h3
                  key={title}
                  className='text-white font-poppins font-semibold hover:cursor-pointe text-[1.6vh] leading-[3vh] xl:text-[1.3vh] xl:leading-[2.5vh]'
                >
                  {title}
                </h3>
              ))}
      ...
      <div className='w-full grid gap-y-[0.3vh] grid-cols-1'>
        {submenus.map((page: MenuProps) => (
          <Link key={page.url} href={page.url}>
            ...
            >
              <Image src={page.iconUrl} width={'17vh'} height={'17vh'} />
              <h3 className='text-white font-poppins ml-[20px] text-[1.6vh] leading-[3vh] xl:text-[1.3vh] xl:leading-[2.5vh]'>
                {page.title}
              </h3>
            </div>
          </Link>
